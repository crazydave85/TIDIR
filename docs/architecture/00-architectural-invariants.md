...
- **Reference Pattern**: Line-rate stream ingestion into open columnar lakehouses (`L2_STORAGE`) backed by object storage (e.g. Apache Iceberg / Parquet) with structured redaction pipelines.
