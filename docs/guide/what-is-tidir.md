...
* **Attackers** leverage automated vulnerability scanning, opportunistic exploit scripts, and Large Language Model (LLM)-assisted vulnerability exploitation ([NCSC Assessment on AI and Cyber Threat](https://www.ncsc.gov.uk/report/impact-of-ai-on-cyber-threat); [Fang et al., 2024](https://arxiv.org/abs/2404.08144)), while relying on living-off-the-land techniques to achieve average breakout times under 62 minutes ([CrowdStrike Global Threat Report](https://www.crowdstrike.com/global-threat-report/)). Over the last 12 months, adversary capability has advanced from bounded one-day exploitation to autonomous zero-day discovery and machine-speed exploit chaining ([Anthropic Claude Mythos System Card, 2026](/architecture/foundational-research#deep-dive-1-ai-risks-adversary-capabilities-the-reality-vs-the-hype); [UK AI Security Institute [AISI] Empirical Evaluations, 2026](/architecture/foundational-research#fnd-17)), culminating in real-world autonomous agent intrusions executing over 17,000 automated attack iterations across a single weekend ([Hugging Face & Cloud Security Alliance [CSA] Post-Mortem, 2026](/architecture/foundational-research#deep-dive-1-ai-risks-adversary-capabilities-the-reality-vs-the-hype)).
